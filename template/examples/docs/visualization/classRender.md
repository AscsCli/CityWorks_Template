...
分类图封装了arcgis的ClassBreaksRenderer，它可以针对图层的字段的值的区间渲染，不能是string类型
...
<script>
     ...
     import {classRenderTool} from  "gismap3";
       ...
       components:{
        ...
        methods:{
            open(){
               ...
               classRenderTool.setRender(this.mapId,"行政区划",this.config);
           ...
           open1(){
              ...
              locateManagerCtrl.queryGraphics(this.mapId,"行政区划","1 = 1").then((r) =>{   
                  ...
                  classRenderTool.setRenderByGraphicLayer(this.mapId,"行政区划data",this.config,r.features);
