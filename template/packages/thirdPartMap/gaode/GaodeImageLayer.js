...
export const gaodeImageLayer  = {}

gaodeImageLayer.create  = function (map) {
  ...
  esriLoader.dojoRequire(["dojo/_base/declare",
    ...
    function (declare,
      ...
      declare("GaoDeImageLayer", TiledMapServiceLayer, {
        name: "GaoDeImageLayer",
        ...
        getTileUrl: function (level, row, col) {
          ...
          let url =  'http://webst0' + (col % 4 + 1) + '.is.autonavi.com/appmaptile?style=6&x=' + col + '&y=' + row + '&z=' + level;
          return url;
        }
      });
      ...
      function loadLayer(map) {
        let  gaoLayer = new GaoDeImageLayer();
